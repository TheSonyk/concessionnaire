 ...
 */
final class Version20210128145326 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE annonces (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, description VARCHAR(255) NOT NULL, kilom�trage INT NOT NULL, chevaux INT NOT NULL, couleur VARCHAR(20) NOT NULL, prix DOUBLE PRECISION NOT NULL, image LONGTEXT DEFAULT NULL, boite VARCHAR(2) NOT NULL, test VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
